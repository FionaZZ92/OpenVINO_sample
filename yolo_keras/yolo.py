...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        print("out score ", out_scores)
        print("out_classes ", out_classes)
        #graph_def = self.sess.graph.as_graph_def()
        #tf.train.write_graph(graph_def, "model", "tf_yolov3.pb", as_text=False)
        #train_writer = tf.summary.FileWriter("./")
        #train_writer.add_graph(graph_def)
        ...
        print("Performance:",(end - start)*1000)
        return image
